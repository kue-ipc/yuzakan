...
RSpec.describe API::Actions::Users::Password::Update do
  ...
  let(:authenticate) {
    instance_double(Yuzakan::Management::Authenticate, call: Success(service))
  }
  let(:change_password) {
    instance_double(Yuzakan::Management::ChangePassword, call: Success([[service]]))
  }
  ...
  describe "authentication failure" do
    let(:authenticate) {
      instance_double(Yuzakan::Management::Authenticate, call: Failure([:failure, failure_message]))
    }
  ...
  describe "unchanged" do
    let(:change_password) {
      instance_double(Yuzakan::Management::ChangePassword, call: Success([[]]))
    }
  ...
  describe "change failure" do
    let(:change_password) {
      instance_double(Yuzakan::Management::ChangePassword, call: Failure([:error, error_message]))
    }
