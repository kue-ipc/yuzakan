    ...
    module Config
      class Update < API::Action
        ...
        params do
          ...
          optional(:auth_failure_waiting).filled(:integer, gteq?: 0, lteq?: 60 * 60)
          optional(:auth_failure_limit).filled(:integer, gteq?: 0, lteq?: 100_000)
          optional(:auth_failure_duratio).filled(:integer, gteq?: 0, lteq?: 24 * 60 * 60)
          ...
          optional(:generate_password_type).filled(:string, included_in?: Yuzakan::Operations::GeneratePassword::TYPES)
