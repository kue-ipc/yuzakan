...
module Legacy
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['LEGACY_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Legacy::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Legacy::Action is included
      ...
      # Configure the code that will yield each time Legacy::View is included
      # This is useful for sharing common functionality
      #
