...
--
-- Name: mappings_provider_id_attr_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX mappings_provider_id_attr_id_index ON public.mappings USING btree (provider_id, attr_id);


--
-- Name: mappings_provider_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX mappings_provider_id_index ON public.mappings USING btree (provider_id);
...
--
-- Name: mappings mappings_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mappings
    ADD CONSTRAINT mappings_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES public.providers(id) ON DELETE CASCADE;
