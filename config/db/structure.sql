...
--
-- Name: provider_params; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.provider_params (
    id integer NOT NULL,
    provider_id integer NOT NULL,
    name text NOT NULL,
...
--
-- Name: provider_params_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.provider_params ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.provider_params_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: provider_params provider_params_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.provider_params
    ADD CONSTRAINT provider_params_pkey PRIMARY KEY (id);
...
--
-- Name: local_users_username_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX local_users_username_index ON public.local_users USING btree (username);
...
--
-- Name: provider_params_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX provider_params_name_index ON public.provider_params USING btree (name);


--
-- Name: provider_params_provider_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX provider_params_provider_id_index ON public.provider_params USING btree (provider_id);


--
-- Name: provider_params_provider_id_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX provider_params_provider_id_name_index ON public.provider_params USING btree (provider_id, name);


--
-- Name: providers_adapter_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX providers_adapter_name_index ON public.providers USING btree (adapter_name);
...
--
-- Name: provider_params provider_params_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.provider_params
    ADD CONSTRAINT provider_params_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES public.providers(id) ON DELETE CASCADE;
...
('10000003000002_create_provider_params.rb'),
